          ...
          <Card>
            <div className="text-center">
              ...
              {profileImage ? (
                ...
                <div className={`w-32 h-32 rounded-full mx-auto mb-4 flex items-center justify-center text-5xl font-bold ${isDark ? 'bg-gray-700 text-white' : 'bg-gray-200 text-gray-700'}`}>
        ...
        <Card header="Preferences">
          <div className="space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
              <p className="font-medium mb-2 text-gray-900 dark:text-white">Interests (for Recommendations)</p>
